 ...
 * 
 * This script migrates the contract in the "geth" test network
 * 
 * The geth is used for ethereum-like deployment to compare with arbitrum 
...
module.exports = function(deployer, network, accounts) {
    ...
    deployer.then(async () => {
        ...
        if(network=="geth") {
            ...
            // Deploy on geth local dev network
